...
Currently, there is only one option for both tasks: sequence alignment is done with \textsc{mafft}\footnote{\href{http://align.bmr.kyushu-u.ac.jp/mafft/software/}{http://align.bmr.kyushu-u.ac.jp/mafft/software/}} and the masking of doubtful alignment position with \textsc{gblocks}\footnote{\href{http://molevol.cmima.csic.es/castresana/Gblocks.html}{http://molevol.cmima.csic.es/castresana/Gblocks.html}}, but further programs might be included in the future. See the respective websites for installation.
